            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Cập nhật FAQ</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            for="phone"
                                            class="col-md-3 ">Câu trả lời</label>
                                        <div class="col-md-9">
                                            <textarea style="height: 300px" id="editor" name="answer">${f.answer}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3" style="display: flex;justify-content: space-between;">
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    name="isActive"
                                                    value="ON"
                                                    <c:if test="${f.isActive}">checked</c:if>
                                                        required
                                                        />
                                                    <label
