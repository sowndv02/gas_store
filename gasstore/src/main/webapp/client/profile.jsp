<%-- 
    Document   : profile
    Created on : May 15, 2023, 11:54:32 PM
    Author     : ADMIN
--%>
        ...
        <div class="body-wrapper">
            ...
            <div class="container">
                ...
                <div class="row pt-10 pb-60">
                    <div class="col-md-3 pb-10 pt-20">
                        <h3 class="text-center">Tài khoản của tôi</h3>
                        <hr style="background: black; height: 2px; margin: 10px;">
                        <ul class="text-center">
                            <c:choose>
                                <c:when test="${sessionScope.account.getClass().getName() eq customerClass}">
                                    <li class="mg-10"><a href="${pageContext.request.contextPath}/client/information">Hồ sơ</a></li>
                                    <li class="mg-10"><a href="${pageContext.request.contextPath}/client/order">Đơn hàng</a></li>
                                    </c:when>
                                    <c:otherwise>
                                    <li class="mg-10"><a href="${pageContext.request.contextPath}/client/information">Hồ sơ</a></li>
                                    <li class="mg-10"><a href="${pageContext.request.contextPath}/client/changepassword">Đổi mật khẩu</a></li>
                                    <li class="mg-10"><a href="${pageContext.request.contextPath}/client/order">Đơn hàng</a></li>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <c:when test="${sessionScope.account.getClass().getName() eq customerClass}">
                                <div class="row">
                                    <div class="login-form col-md-8">
                                        <h4 class="login-title">Thông tin cá
                                            nhân</h4>
                                        <div class="row">
                                            <div class="col-md-12 mb-20">
                                                <label>Username</label>
                                                <input class="mb-0" type="text"
                                                       placeholder="SA" value="${sessionScope.account.id}" readonly>
                                            </div>
                                            <div class="col-md-6 col-12 mb-20">
                                                <label>First Name</label>
                                                <input class="mb-0" type="text"
                                                       placeholder="First Name" name="firstName" readonly value="${sessionScope.account.family_name}">
                                            </div>
                                            <div class="col-md-6 col-12 mb-20">
                                                <label>Last Name</label>
                                                <input class="mb-0" type="text"
                                                       placeholder="Last Name" name="lastName" readonly value="${sessionScope.account.given_name}">
                                            </div>
                                            <div class="col-md-12 mb-20">
                                                <label>Email Address*</label>
                                                <input class="mb-0" type="email"
                                                       placeholder="Email Address" readonly name="email" value="${sessionScope.account.email}">
                                            </div>
                                        </div>

                                    </div>
                                    <div class="col-md-4">
                                        <img class="mb-10" src="${sessionScope.account.picture}" />
                                    </div>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <form method="post" action="${pageContext.request.contextPath}/client/information" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="login-form col-md-8">
                                            <h4 class="login-title">Thông tin cá
                                                nhân</h4>
                                            <div class="row">
                                                <div class="col-md-12 mb-20">
                                                    <label>Username</label>
                                                    <input class="mb-0" type="text"
                                                           placeholder="SA" value="${sessionScope.account.userName}" readonly>
                                                </div>
                                                <div class="col-md-6 col-12 mb-20">
                                                    <label>First Name</label>
                                                    <input class="mb-0" type="text"
                                                           placeholder="First Name" required name="firstName" value="${sessionScope.account.firstName}">
                                                </div>
                                                <div class="col-md-6 col-12 mb-20">
                                                    <label>Last Name</label>
                                                    <input class="mb-0" type="text"
                                                           placeholder="Last Name" required name="lastName" value="${sessionScope.account.lastName}">
                                                </div>
                                                <div class="col-md-12 mb-20">
                                                    <label>Email Address*</label>
                                                    <input class="mb-0" type="email"
                                                           placeholder="Email Address" required name="email" value="${sessionScope.account.email}">
                                                </div>

                                                <div class="col-md-12 mb-20">
                                                    <label>Address</label>
                                                    <input class="mb-0" type="text"
                                                           placeholder="Address" required name="address" value="${sessionScope.account.address}">
                                                </div>
                                                <div class="col-md-12 mb-20">
                                                    <label>Phone</label>
                                                    <input class="mb-0" type="text"
                                                           placeholder="PhoneNumber" required name="phone" value="${sessionScope.account.phone}">
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-20">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class=" row col-md-4 col-12 mb-20 mr-100">
                                                            <label for="male" class="col-md-4">Male</label>
                                                            <input id="male" name="gender" class="col-md-6 mb-0 h-75" type="radio"
                                                                   placeholder="First Name" value="male" <c:if test="${sessionScope.account.gender}">checked</c:if> >
                                                            </div>
                                                            <div class="row col-md-4 col-12 mb-20 ">
                                                                <label for="female"  class="col-md-6">Female</label>
                                                                <input id="female" name="gender" class="col-md-6 mb-0 h-75" type="radio"
                                                                       placeholder="Last Name" value="female" <c:if test="${!sessionScope.account.gender}">checked</c:if>>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <img class="mb-10" src="data:image/jpg;base64,${sessionScope.account.base64Image}" />
                                            <input class="mt-10" type="file" name="photo" />
                                        </div>
                                    </div>
                ...
                <div class="footer">
                    ...
                    <div class="footer-static-top">
                        <div class="container">
                            ...
                            <div class="footer-shipping pt-60 pb-55
                                 pb-xs-25">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6
                                        ...
                                        <div class="li-shipping-inner-box">
                                            ...
                                            <div class="shipping-text">
                                                ...
                                                <p>Our Buyer Protection
                                                    covers your purchasefrom
                                                    click to delivery.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container">
                            <div class="footer-logo-wrap pt-50 pb-35">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-6">
                                        <div class="footer-block">
                                            <h3 class="footer-block-title">Our
                                                company</h3>
                                            <ul>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="footer-block">
                                            <h3 class="footer-block-title">Follow
                                                Us</h3>
