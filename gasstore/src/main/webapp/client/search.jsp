    ...
    <body>
        ...
        <div class="body-wrapper">
            ...
            <div class="content-wraper pt-60 pb-60 pt-sm-30">
                <div class="container">
                    <div class="row">
                        <h3>Tìm kiếm với từ khoá "${requestScope.key}": Kết quả: ${requestScope.listAllType.size()} được tìm thấy</h3>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                                            ...
                                                            <div class="single-product-wrap">
                                                                <div class="product-image">
                                                                    <a href="${pageContext.request.contextPath}/client/item?id=${p.productId}">
                                                                        <img style="width: 250px; height: 350px"  src="data:image/jpg;base64,${p.base64Image}" alt="Preview" />
                                                                    </a>
                                                                </div>
                                                                <div class="product_desc">
                                                                    <div class="product_desc_info">
                                                                        ...
                                                                        <h4><a class="product_name" href="${pageContext.request.contextPath}/client/item?id=${p.productId}">${p.name}</a></h4>
                                                                        <div class="price-box">
