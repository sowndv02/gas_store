<%-- 
    ...
    Created on : May 15, 2023, 10:23:45 PM
    Author     : ADMIN
--%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-10 col-xs-12">
                            ...
                            <form action="${pageContext.request.contextPath}/client/changepassword2" id="myForm" method="post" >
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input class="mb-0" type="text" readonly value="${requestScope.userName}" id="userName" placeholder="Sơn">
                                        </div>

                                        <div class="col-md-12 mb-20">
                                            <label>Email Address*</label>
                                            <input class="mb-0" type="email" value="${requestScope.email}" id="email" name="email" readonly placeholder="Email Address">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button type="button" onclick="validChangePassword()" class="register-button mt-0">Lưu </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
