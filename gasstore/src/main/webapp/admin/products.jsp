                                    ...
                                    <tbody class="customtable">
                                        <c:forEach items="${requestScope.listAllProducts}" var="pro">
                                            <tr>
                                                ...
                                                <td><input readonly value="${pro.isActive}" type="checkbox" <c:if test="${pro.isActive}">checked</c:if> ></td>
                                                <td><a href="${pageContext.request.contextPath}/admin/updateproduct?pid=${pro.productId}"><i class="fas fa-edit"></i></a></td>
                                            </tr>
                                        </c:forEach>
