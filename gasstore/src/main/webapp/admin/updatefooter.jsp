                            ...
                            <div class="card-body">
                                ...
                                <form action="updatefooter" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="content" name="content" value ="${footer.content}" required/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="description" class="col-md-3 ">Mô tả</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="description" name="description" value ="${footer.description}" required/>
                                        </div>
                                    </div>
