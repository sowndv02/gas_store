                    ...
                    <div class="container-fluid"  style="border: 1px solid black; margin: 10px 0 ">
                        <form style="margin-top: 10px;">
                                    ...
                                    <select
                                        ...
                                        <optgroup label="Danh mục">
                                            <c:forEach items="${requestScope.listAllCategories}" var="cate">
                                                <option <c:if test="${requestScope.category != 'Select' && cate.categoryId eq requestScope.category }">selected</c:if> value="${cate.categoryId}">${cate.name}</option>
                                            </c:forEach>
                                        </optgroup>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="btn_search mb-10" style="display: grid; place-items: center; margin-bottom:20px ">
                        ...
                        <div id="content" class="row el-element-overlay">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="${pageContext.request.contextPath}/admin/products"><h5 class="card-title mb-0">Sản phẩm (${requestScope.listAllProducts.size()})</h5></a>
                            </div>
                            <div>
                                <button type="button" class="btn btn-primary" onclick="selectAllCheckbox()">Select All</button>
                                <button type="button" class="btn btn-danger" onclick="uncheckAllCheckbox()">Deselect All</button>
                            </div>
                            <form action="newdiscount" method="POST" class="mt-5">
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody class="customtable">
                                            <c:forEach items="${requestScope.listAllProducts}" var="pro">
                                                <tr>
                                                    <td><input type="checkbox" name="pro" value="${pro.productId}"></td>
                                                    <td>${pro.productId}</td>
                                                    <td><a href="${pageContext.request.contextPath}/client/item/${pro.code}">${pro.name}</a></td>
                                                    ...
                                                    <td>${pro.unitOnOrders}</td>
                                                    <td><c:if test="${pro.isActive}">Chưa</c:if><c:if test="${!pro.isActive}">Đã ngưng</c:if>
                                ...
                                <h5 class="text-header">ADD DISCOUNT</h5>

                                <div class="form-group row">
                                    <label class="col-md-3 mt-3">Discount</label>
                                    <div class="col-md-9">
                                        <select
                                            name="discountID"
                                            id="discount"
                                            ...
                                            <optgroup label="Danh mục">
                                                ...
                                                <c:forEach items="${requestScope.listAllDiscount}" var="d">
                                                    <option value="${d.discountId}">${d.name}</option>
                                                </c:forEach>
                                            </optgroup>
                                        </select>
                                    </div>
                                ...
                                <div style="display: grid; place-items: center; margin-bottom: 20px">
                                    <button style="width: 30%" class=" btn btn-info">Add</button>
                                </div>
                            </form>
                        </div>
                    </div>
