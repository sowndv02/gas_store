<%-- 
    Document   : orders
    Created on : May 20, 2023, 11:26:55 AM
    Author     : ADMIN
--%>
        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <!-- column -->
                        <c:if test="${requestScope.type == 'shipping'}">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="${pageContext.request.contextPath}/admin/orders" method="post" id="form0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h4 class="card-title mb-0">Đơn hàng đang giao hàng(${requestScope.getShippingOrders.size()})<br><br> Từ ${requestScope.from0} đến ${requestScope.to0}</h4>
                                                </div>
                                                <div class="col-md-2"><label for="from0">From&nbsp;&nbsp;&nbsp;</label><input id="from0" name="from0" value="${requestScope.from0}" type="date"></div>
                                                <div class="col-md-2"><label for="to0">To&nbsp;&nbsp;&nbsp;</label><input id="to0" type="date" value="${requestScope.to0}" name="to0"></div>
                                                ...
                                                <div class="d-flex flex-row comment-row mt-0 ordersShipping">
                                                    ...
                                                    <div class="comment-text w-100">
                                                        ...
                                                        <span class="mb-3 d-block">
                                                            ...
                                                            Payment: <c:choose>
                                                                <c:when test="${orderShip.payment}">Đã thanh toán</c:when>
                                                ...
                                                <div class="d-flex flex-row comment-row mt-0 orders">
                                                    ...
                                                    <div class="comment-text w-100">
                                                        ...
                                                        <span class="mb-3 d-block">
                                                            ...
                                                            TrackingNumber: <a href="">#${orderNew.trackingNumber}</a><br>
                                                            Shipper: <a href="">${orderNew.shipment.companyName}</a><br>
                                                            Payment: <c:choose>
                                                                <c:when test="${orderNew.payment}">Đã thanh toán</c:when>
                                                                <c:otherwise>Chưa thanh toán</c:otherwise>
                                                            </c:choose><br>
                        ...
                        <c:if test="${empty requestScope.type}">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-body">
                                            <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/admin/orderdetail?oid=${requestScope.order.orderId}">OrderID: #${requestScope.order.orderId}</a></h4>    
                                        </div> 
                                        <div class="comment-widgets scrollable">
                                            <!-- Comment Row -->
                                            <div class="d-flex flex-row white-box comment-row mt-0 ordersProcess">
                                                <div class="p-2">
                                                    <img
                                                        src="data:image/jpg;base64,${requestScope.order.customer.base64Image}"
                                                        alt="user"
                                                        width="50"
                                                        height="50"
                                                        class="rounded-circle"
                                                ...
                                                <div class="comment-text w-100">
                                                    <a href="${pageContext.request.contextPath}/admin/profile?type=customer&id=${requestScope.order.customer.customerID}">${requestScope.order.customer.firstName} ${requestScope.order.customer.lastName}</a>
                                                    <span class="mb-3 d-block">
                                                        <a href="${pageContext.request.contextPath}/admin/orderdetail?id=${requestScope.order.customer.customerID}&oid=${requestScope.order.orderId}">OrderID: ${requestScope.order.orderId}</a><br>
                                                        OrderDate: ${order.orderDate}<br>
                                                        RequiredDate: ${order.requiredDate}<br>
                                                        TotalMoney: <fmt:formatNumber value = "${Math.round((order.totalMoney)/1000)*1000}" type = "currency"/><br>
                                                        Trạng thái: <c:choose>
                                                            <c:when test="${order.status == 1}">Thành công</c:when>
                                                            <c:otherwise>Thất bại</c:otherwise>
                                                        </c:choose><br>
                                                    ...
                                                    <div class="comment-footer">
                                                        ...
                                                        <button
                                                            ...
                                                            class="btn btn-cyan btn-sm text-white"
                                                            >
                                                            <a class="text-white" href="${pageContext.request.contextPath}/admin/orderdetail?id=${requestScope.order.customer.customerID}&oid=${requestScope.order.orderId}">
                                                                Information 
                                                            </a>
                                                        </button>
                                                    </div>
