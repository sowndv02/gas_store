 ...
 * @author ADMIN
 */
public class Changepassword2AdminServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Changepassword2AdminServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Changepassword2AdminServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(email == null || newPassword == null || cfNewPassword == null){
        ...
        if (!newPassword.equals(cfNewPassword)) {
            ...
            int number = daoAdmin.ChangePassword(admin);
            if (number > 0) {
