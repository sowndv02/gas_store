                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form id="example-form" action="othernewdiscount" method="post" class="mt-5" >
                                
                                <div>
                                    <section>
                                        <c:forEach items="${provalues}" var="item" varStatus="status">
                                            <input type="hidden" name="pro" value="${item}" />
                                        </c:forEach>
                                        <label>Name *</label>
                                        ...
                                        <div class="col-sm-12 row">
                                            <div class="col-md-11">
                                                <input value="" type="number" class="form-control required" aria-describedby="basic-addon2"
                                        ...
                                        <input name="couponCode" type="text" class="required form-control" />
                                        <label>Start Date *</label>
                                        <input name="startDate" type="date" class="required form-control" />
                                        <label>Expiration Date *</label>
                                        <input name="expirationDate" type="date" class="required form-control" />
                                    </section>
                                </div>
