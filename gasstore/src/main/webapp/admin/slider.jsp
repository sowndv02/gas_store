                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form id="example-form" action="slide" method="post" class="mt-5" enctype="multipart/form-data">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group mt-3">
                                                ...
                                                <img src="${pageContext.request.contextPath}/${requestScope.i0}" alt=""/>
                                                <br/>
                                                <input
                                                    type="file"
                                                    name="add1"
                                                    ...
                                                    />
                                                <br/>
                                                <small class="text">Giới thiệu</small>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <br/>
                                                <img src="${pageContext.request.contextPath}/${requestScope.i1}" alt=""/><br/>
                                                <input
                                                    type="file"
                                                    name="add2"
                                                    class="banner"
                                                    ...
                                                    />
                                                <br/>
                                                <small class="text">Sản phẩm nổi bật</small>
                                            </div>
                                            <div class="form-group">
                                                <label
                                                    >Banner 3
                                                </label><br/>
                                                <img src="${pageContext.request.contextPath}/${requestScope.i2}" alt=""/>
                                                <br/>
                                                <input
                                                    type="file"
                                                    name="add3"
                                                    ...
                                                    />
                                                <br/>
                                                <small class="text">Bảo hành</small>
                                                <br/>
                                            </div>
                                            <input
                                                type="submit"
