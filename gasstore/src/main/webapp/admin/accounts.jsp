<%-- 
    Document   : accounts
    Created on : May 17, 2023, 3:23:13 PM
    Author     : ADMIN
--%>
                        ...
                        <ul class="navbar-nav float-start me-auto">
                            ...
                            <li class="nav-item search-box">
                                <a
                                    ...
                                    ></a>
                                <form class="app-search position-absolute" action="${pageContext.request.contextPath}/admin/accounts" method="POST">
                                    <input
                                        type="email"
                                        name="key"
                                        class="form-control"
                                        ...
                                        <c:forEach items="${requestScope.listAllCustomers}" var="c">
                                            <tr>
                                                ...
                                                <td><c:if test="${!c.gender}">Nữ</c:if><c:if test="${c.gender}">Nam</c:if></td>
                                                    <td> Khách hàng</td>
                                                <th><c:choose>
                                                        <c:when test="${c.status}">Hoạt động</c:when>
                                                        <c:when test="${!c.status}">Bị khoá</c:when>
                                                    </c:choose></th>
                                                    <th><a href="${pageContext.request.contextPath}/admin/profile?type=customer&id=${c.customerID}"><i class="fas fa-edit"></i></a></th>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                                            ...
                                            <nav aria-label="...">
                                                <ul class="pagination">
                                                    <li class="page-item <c:if test="${requestScope.page == 1}">disabled</c:if>">
                                                        <a  class="page-link" href="${pageContext.request.contextPath}/admin/accounts?page=${page-1}" tabindex="-1"
                                                           >Previous</a
                                                        >
                                                    </li>
                                                    <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                                    <li class="page-item ${i==page?"active":""}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/accounts?page=${i}">${i}</a>
                                                    </li>
                                                    </c:forEach>
                                                    <li class="page-item <c:if test="${requestScope.page == num}">disabled</c:if>">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/accounts?page=${page+1}">Next</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                        </div>
