                            ...
                            <div class="card-body">
                                <form action="updateblog" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="title" placeholder="Loại Blog" name="title" value ="${blog.title}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="description" name="description" style="width: 100%; height: 200px;">${blog.description}
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea id="editor" name="content">${blog.content}
                                        </textarea>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="image-area">
                                                <img src="${pageContext.request.contextPath}/${requestScope.blog.base64Image}" alt="Preview" />
                                        </div>
