                        ...
                        <ul id="sidebarnav" class="pt-4">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="${pageContext.request.contextPath}/admin/changepassword" class="sidebar-link"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.footers}" var="footer">
                                                <tr>
                                                    <td scope="row">${footer.content}</td>
                                                    <td scope="row">${footer.description}</td>
                                                    <td scope="row">
                                                        <form action="updatefooter" class="mb-3">
