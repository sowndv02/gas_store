                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.typeblogs}" var="typeblog">
                                                <tr>
                                                    <td scope="row">${typeblog.typeId}</td>
                                                    <c:if test="${requestScope.updattingTypeId == null || requestScope.updattingTypeId !=  typeblog.typeId}">
                                                        <td scope="row">${typeblog.typeName}</td>
                                                    </c:if>
                                                    <c:if test="${requestScope.updattingTypeId != null && requestScope.updattingTypeId ==  typeblog.typeId}">
                                                        <td scope="row">
                                                            <form action="managetypeblog" method="post">
                                                                <input type="hidden" name="typeId" value="${typeblog.typeId}">
                                                                <input type="text" required name="updatingContent" value="${typeblog.typeName}">
                                                                <input type="hidden" name="action" value="update2">
                                                                <button class="btn btn-primary" type="submit" >Xác nhận</button>
                                                            </form>
                                                        </td>
                                                    </c:if>
                                                    <td scope="row">${typeblog.createdDate}</td>
                                                    <td scope="row">${mapAdmin.get(typeblog.createdBy)}</td>
                                                    <td scope="row">
                                                        <form action="managetypeblog" method="post">
                                                            <input type="hidden" name="typeId" value="${typeblog.typeId}">
                                ...
                                <form action="managetypeblog" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="typeName" class="col-md-3 ">Tên loại</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="catename" placeholder="Loại Blog" name="typeName" required/>
                                        </div>
                                    </div>
