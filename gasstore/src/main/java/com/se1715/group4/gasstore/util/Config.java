...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:3979/gasstore/client/statuspayments";
    public static String vnp_TmnCode = "QTZMMAYF";
    public static String vnp_HashSecret = "BNYUCWAZFKZLIBBXLLMRNTBFPLPKQMKE";
    public static String vnp_apiUrl = "https://sandbox.vnpayment.vn/merchant_webapi/api/transaction/index.html";
