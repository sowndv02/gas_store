                    ...
                    <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                        <ul class="navbar-nav float-start me-auto">
                            ...
                            <li class="nav-item search-box">
                                ...
                                <form class="app-search position-absolute" action="${pageContext.request.contextPath}/admin/orders" method="post">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="${pageContext.request.contextPath}/admin/generateorders" method="get" id="formr">
                                        <input type="hidden" name="status" value="done">
                                        <div class="row">
                                            <div class="col-md-7">
                                                <h4 class="card-title mb-0">Xuất file Excel</h4>
                                            </div>
                                            <div class="col-md-2"><label for="fromr">From&nbsp;&nbsp;&nbsp;</label><input id="fromr" name="fromr" type="date"></div>
                                            <div class="col-md-2"><label for="tor">To&nbsp;&nbsp;&nbsp;</label><input id="tor" type="date" name="tor"></div>
                                            <div class="col-md-1"><button class="btn-orange border-0 text-white" type="button" onclick="checkFormr()" >Nhận file</button></div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="${pageContext.request.contextPath}/admin/orders" method="post" id="form0">
                                        <input type="hidden" name="status" value="shipping">
                                        <div class="row">
                                            <div class="col-md-7">
                                                <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/admin/orders">Đơn hàng đang giao hàng(${requestScope.sizeShipping})</a></h4>
                                            </div>
                                ...
                                <div class="comment-widgets scrollable">
                                    <!-- Comment Row -->
                                    <div id="contentShip">
                                        <c:forEach items="${requestScope.getShippingOrders}" var="orderShip">
                                            <div class="d-flex flex-row comment-row mt-0 ordersShipping">
                                                <div class="p-2">
                                                    <img
                                                        src="data:image/jpg;base64,${orderShip.customer.base64Image}"
                                                        alt="user"
                                                        width="50"
                                                        height="50"
                                                ...
                                                <div class="comment-text w-100">
                                                    <a href="${pageContext.request.contextPath}/admin/profile?type=customer&id=${orderShip.customer.customerID}">${orderShip.customer.firstName} ${orderNew.customer.lastName}</a>
                                                    <span class="mb-3 d-block">
                                                        <a href="${pageContext.request.contextPath}/admin/orderdetail?oid=${orderShip.orderId}">OrderID: ${orderShip.orderId}</a><br>
                                                        OrderDate: ${orderShip.orderDate}<br>
                                                        RequiredDate: ${orderShip.requiredDate}<br>
                                                        TrackingNumber: <a href="">#${orderShip.trackingNumber}</a><br>
                                                        Shipper: <a href="">${orderShip.shipment.companyName}</a><br>
                                                        Payment: <c:choose>
                                                            <c:when test="${orderShip.payment == 1}">Đã thanh toán</c:when>
                                                            <c:when test="${orderShip.payment == 2}">Thanh toán khi nhận hàng</c:when>
                                                            <c:otherwise>Chưa thanh toán</c:otherwise>
                                                        </c:choose><br>
                                                        TotalMoney: <fmt:formatNumber value = "${Math.round((orderShip.totalMoney)/1000)*1000}" type = "currency"/><br>
                                                        Notes: ${orderShip.notes}<br>
                                                    </span>
                                                    <div class="comment-footer">
                                                        <span class="text-muted float-end">${orderShip.orderDate}</span>
                                                        <button
                                                            type="button"
                                                            class="btn btn-cyan btn-sm text-white"
                                                            >
                                                            <a class="text-white" href="${pageContext.request.contextPath}/admin/orderdetail?id=${orderShip.customer.customerID}&oid=${orderShip.orderId}">
                                                                Information 
                                                            </a>
                                                        </button>
                                                        <button
                                                            type="button"
                                                            onclick="updateOrder(${orderShip.orderId}, 'done')"
                                                        ...
                                                        <button
                                                            type="button"
                                                            onclick="updateOrder(${orderShip.orderId}, 'reject')"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="${pageContext.request.contextPath}/admin/orders" method="post" id="form1">
                                ...
                                <div class="comment-widgets scrollable">
                                    <!-- Comment Row -->
                                    <div id="content">
                                        <c:forEach items="${requestScope.getNewOrders}" var="orderAccept">
                                            <div class="d-flex flex-row comment-row mt-0 orders">
                                                <div class="p-2">
                                                    <img
                                                        src="data:image/jpg;base64,${orderAccept.customer.base64Image}"
                                                        alt="user"
                                                        width="50"
                                                        height="50"
                                                        class="rounded-circle"
                                                ...
                                                <div class="comment-text w-100">
                                                    <a href="${pageContext.request.contextPath}/admin/profile?type=customer&id=${orderAccept.customer.customerID}">${orderAccept.customer.firstName} ${orderAccept.customer.lastName}</a>
                                                    <span class="mb-3 d-block">
                                                        <a href="${pageContext.request.contextPath}/admin/orderdetail?oid=${orderAccept.orderId}">OrderID: ${orderAccept.orderId}</a><br>
                                                        OrderDate: ${orderAccept.orderDate}<br>
                                                        RequiredDate: ${orderAccept.requiredDate}<br>
                                                        TrackingNumber: <a href="">#${orderAccept.trackingNumber}</a><br>
                                                        Shipper: <a href="">${orderAccept.shipment.companyName}</a><br>
                                                        Payment: <c:choose>
                                                            <c:when test="${orderAccept.payment == 1 }">Đã thanh toán</c:when>
                                                            <c:when test="${orderAccept.payment == 2 }">Thanh toán khi nhận hàng</c:when>
                                                            <c:otherwise>Chưa thanh toán</c:otherwise>
                                                        </c:choose><br>
                                                        TotalMoney: <fmt:formatNumber value = "${Math.round((orderAccept.totalMoney)/1000)*1000}" type = "currency"/><br>
                                                        Notes: ${orderAccept.notes}<br>
                                                    </span>
                                                    <div class="comment-footer">
                                                        <span class="text-muted float-end">${orderAccept.orderDate}</span>
                                                        <button
                                                            type="button"
                                                            class="btn btn-cyan btn-sm text-white"
                                                            >
                                                            <a class="text-white" href="${pageContext.request.contextPath}/admin/orderdetail?oid=${orderAccept.orderId}">
                                                                Information 
                                                            </a>
                                                        </button>
                                                        <button
                                                            type="button"
                                                            onclick="updateOrder(${orderAccept.orderId}, 'accept')"
                                                            class="btn btn-success btn-sm text-white"
                                                            >
                                                            Accept
                                                        </button>
                                                        <button
                                                            type="button"
                                                            onclick="updateOrder(${orderAccept.orderId}, 'reject')"
                                                            class="btn btn-danger btn-sm text-white"
                                                            >
                                                            Reject
                                                        </button>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-body">
                                        <form action="${pageContext.request.contextPath}/admin/orders" method="post" id="form2">
                                            <input type="hidden" name="status" value="done">
                                            <div class="row">
                                                <div class="col-md-7">
                                        ...
                                        <c:forEach items="${requestScope.getProcessOrders}" var="orderNew">
                                            <div class="d-flex flex-row comment-row mt-0 ordersProcess">
                                                ...
                                                <div class="comment-text w-100">
                                                    ...
                                                    <span class="mb-3 d-block">
                                                        <a href="${pageContext.request.contextPath}/admin/orderdetail?oid=${orderNew.orderId}">OrderID: ${orderNew.orderId}</a><br>
                                                        ...
                                                        Trạng thái: <c:choose>
                                                            <c:when test="${orderNew.status == 1}">Thành công</c:when>
                                                            <c:otherwise>Thất bại</c:otherwise>
                                                        </c:choose><br>
                                                        Notes: ${orderNew.notes}<br>
                                                    </span>
                                                    <div class="comment-footer">
                                                        ...
                                                        <button
                                                            ...
                                                            class="btn btn-cyan btn-sm text-white"
                                                            >
                                                            <a class="text-white" href="${pageContext.request.contextPath}/admin/orderdetail?oid=${orderNew.orderId}">
                                                                Information 
                                                            </a>
                                                        </button>
                                                    </div>
