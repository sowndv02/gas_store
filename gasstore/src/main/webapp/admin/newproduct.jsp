        ...
        <div
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- ============================================================== -->
                    <div class="card">
                        <form id="example-form" action="${pageContext.request.contextPath}/admin/addproduct" method="POST" class="mt-5" enctype="multipart/form-data">
                            <div class="card-body wizard-content">
                                ...
                                <div>
                                            ...
                                            <select
                                                ...
                                                <optgroup label="Discount">
                                                    <c:forEach items="${requestScope.discounts}" var="d">
                                                        <option value="${d.discountId}"><fmt:formatNumber type = "percent" value = "${d.discount}" /></option>
                                                    </c:forEach>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <label class="col-md-3 mt-3">Hình ảnh đại diện<br></label>
                                    ...
                                    <textarea style="height: 500px;" id="editor" name="description">
                                    </textarea><br/>
...
//                                        }
                                        ...
                                        function formatPrice() {
                                            ...
                                            let price = priceInput.value.replace(/[^0-9]/g, ''); // Remove non-numeric characters
                                            let formattedPrice = "";
                                            for (let i = 0; i < price.length; i++) {
                                                if (i > 0 && (price.length - i) % 3 === 0) {
                                                    formattedPrice += ".";
                                                }
