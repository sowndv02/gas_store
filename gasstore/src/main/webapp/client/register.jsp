<%-- 
    Document   : register
    Created on : May 14, 2023, 1:05:07 AM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Register Gas Petro</title>
    ...
    <body>
        ...
        <div class="body-wrapper">
            ...
            <div class="page-section mb-60">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-10 col-xs-12 mb-30">
                            <form class="needs-validation" action="${pageContext.request.contextPath}/client/register" method="POST" id="myForm">
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input class="mb-0" type="text" name="userName" id="userName" placeholder="UserName">
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>First Name</label>
                                            <input class="mb-0" type="text" name="firstName" id="firstName" placeholder="First Name">
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Last Name</label>
                                            <input class="mb-0" type="text" name="lastName" id="lastName" placeholder="Last Name">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                        ...
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <input class="mb-0" type="password" id="cfPassword" name="cfPassword" placeholder="Confirm Password">
                                        </div>
                                        <div class="col-12">
                                            <button type="button" onclick="validateRegistrationForm()" class="register-button mt-0">Register</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
