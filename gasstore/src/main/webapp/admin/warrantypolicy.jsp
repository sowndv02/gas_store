                                        ...
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <thead class="thead-light">
                                                    <tr>
                                                        <c:forEach items="${requestScope.listAllCate}" var="c">
                                                            <th scope="col" colspan="2">${c.name}</th>
                                                            <th scope="col"><a href="${pageContext.request.contextPath}/admin/updatewp?cid=${c.categoryId}">Cập nhật</a></th>
                                                        </c:forEach>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody class="customtable">
                                                        ...
                                                        <tr>
                                                            <c:forEach items="${requestScope.listAllWp}" var="pro">
                                                            <td>${pro.policy1}</td>
                                                            <td>${pro.policy2}</td>
                                                            <td>${pro.policy3}</td>
                                                            </c:forEach>
