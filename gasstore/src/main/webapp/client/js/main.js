...
(function ($) {
    ...
    /*  02. Header Dropdown
     /*----------------------------------------*/
    // Li's Dropdown Menu
    $('.ht-setting-trigger, .ht-currency-trigger, .ht-language-trigger, .hm-minicart-trigger, .cw-sub-menu, .order-list, .wname').on('click', function (e) {
        e.preventDefault();
        $(this).toggleClass('is-active');
        $(this).siblings('.ht-setting, .ht-currency, .ht-language, .minicart, .cw-sub-menu li, .cass, .product-desc').slideToggle();
        $(this).children().children().children('.arrowdown').toggleClass('is-active');
    });
...
function f(a)
{
    ...
    if (!/\D/.test(z))
    {
        $.get("process?num="+ z +"&id=" + a, function (data) {
            $(".ad" + a).html(data);
        });
        $.get("process1?id=" + a, function (data) {
            $(".minicart-total").html(data);
...
function g(a)
{
    let text = "Hủy đơn hàng này ?";
    if (confirm(text) === true) {
        $.get("delorder?id=" + a, function (data) {
...
$(".status1").each(function (){
    $(this).children().children().children().children('.step').toggleClass('completed');
    $(this).children().children().children('.status').children().children().toggleClass('completed');
});

$(".status2").each(function (){
    $(this).children().children().children().children('.step:first-child').toggleClass('completed');
    $(this).children().children().children('.status').children().children().toggleClass('completed');
...
$(".status3").each(function (){
    $(this).children().children().children().children('.step').toggleClass('completed');
    $(this).children().children().children('.steps').children('.step:last-child').toggleClass('completed');
    $(this).children().children().children('.status').children().children().toggleClass('completed');
});

$(".status0.process2").each(function (){
        $(this).children().children().children().children('.step:first-child').toggleClass('completed');
        $(this).children().children().children('.steps').children('.step:first-child').toggleClass('fail');
        $(this).children().children().children('.status').children().children().toggleClass('fail');
});

$(".status0.process3").each(function (){
        $(this).children().children().children().children('.step').toggleClass('completed');
    $(this).children().children().children('.steps').children('.step:last-child').toggleClass('completed');
        $(this).children().children().children('.steps').children('.step:first-child').toggleClass('fail');
        $(this).children().children().children('.status').children().children().toggleClass('fail');
...
$(".dl0").each(function (){
    $(this).children().toggleClass('fail');
});
