<%-- 
    Document   : inputotp
    Created on : May 15, 2023, 9:30:28 PM
    Author     : ADMIN
--%>
...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>Hỗ trợ mật khẩu - OTP</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-10 col-xs-12">
                            <h4 class="alert-danger">Vui lòng kiểm tra email và nhập OTP mà bạn nhận được</h4>
                            <h4 class="alert-danger">${requestScope.error}</h4>
                            <form id="myForm" action="${pageContext.request.contextPath}/client/authencationotp" method="POST">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input class="mb-0" type="text" name="userName" value="${requestScope.userName}" readonly placeholder="username">
                                        </div>

                                        <div class="col-md-12 mb-20">
                                            <label>Email</label>
                                            <input class="mb-0" type="email" name="email" value="${requestScope.email}" readonly placeholder="Email">
                                        </div>


                                        <div class="col-md-12 mb-20">
                                            <label>OTP</label>
                                            <input required class="mb-0" type="text" id="otp" name="otp" placeholder="Nhập OTP">
                                        </div>

                                        <div class="col-9">
                                            <button type="button" onclick="validateOTP()" class="register-button mt-0">Tiếp tục</button>
                                        </div>

                                        <div class="col-3">
                                            <button type="reset" class="btn-clear-all mt-0">Clear</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
