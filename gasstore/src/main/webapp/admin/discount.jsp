                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <h5 class="text-danger">Giảm giá đang hoạt động</h5>
                                            <thead>
                                                <tr>
                                                    <td>ID</td>
                                                    <td>Tên</td>
                                                ...
                                                <c:if test="${d.isActive}">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>${d.name}</td>
                                                            <td>${d.description}</td>
                                                            <td><input value="${d.isActive}" type="checkbox" <c:if test="${d.isActive}">checked</c:if> disabled></td>
                                                            <td><fmt:formatNumber value="${d.discount}" maxIntegerDigits="3" type="PERCENT"/></td>
                                                            <td>${d.couponCode}</td>
                                                            <td>${d.startDate}</td>
                                                            <td>${d.expirationDate}</td>
                                                            <td><a href="${pageContext.request.contextPath}/admin/discountdetail?did=${d.discountId}">Thông tin</a></td>
                                                            <td><a href="${pageContext.request.contextPath}/admin/updatediscount?did=${d.discountId}"><i class="fas fa-edit"></i></a></td>
                                                        </tr>
                                                    </tbody>
                                                </c:if>
                                            </c:forEach>
                                ...
                                <div class="table-responsive">
                                    <table
                                        class="table table-striped table-bordered"
                                        >
                                        <h5 class="text-danger">Giảm giá đã dừng hoạt động</h5>
                                        <thead>
                                            <tr>
                                                <!--                                                <td>Discount ID</td>
                                                                                                <td>Name</td>
                                            ...
                                            <c:if test="${!d.isActive}">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>${d.description}</td>
                                                        <td><input value="${d.isActive}" type="checkbox" <c:if test="${d.isActive}">checked</c:if> disabled></td>
                                                        <td><fmt:formatNumber value="${d.discount}" pattern="#.##"/></td>
                                                        <td>${d.couponCode}</td>
                                                        <td>${d.startDate}</td>
                                                        <td>${d.expirationDate}</td>
                                                        <td><a href="${pageContext.request.contextPath}/admin/discountdetail?did=${d.discountId}">Thông tin</a></td>
                                ...
                                <button class="btn btn-primary"><a class="text-white" href="${pageContext.request.contextPath}/admin/newdiscount">Add Discount</a></button>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
