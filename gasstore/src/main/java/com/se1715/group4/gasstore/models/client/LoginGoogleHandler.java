...
public class LoginGoogleHandler extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Customer c = daoCustomer.checkLoginGoogle(user.getId());
            if(c == null){
                
                out.print(daoCustomer.AddLoginGoogle(user));
                Customer b = daoCustomer.checkLoginGoogle(user.getId());
                session.setAttribute("customer", b);
            }else{
