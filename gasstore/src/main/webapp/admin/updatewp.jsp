...
<html>
    <head>
        ...
        <title>Cập nhật Chính sách bảo hành</title>
        <!-- Favicon icon -->
        <link
            rel="icon"
            type="image/png"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="updatecategory" method="POST">
                                <input type="hidden" value="${requestScope.category.warrantyPolicyID}" name="categoryID">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label
                                                for="des"
                                                class="col-md-3 ">Đoạn 1</label>
                                            <div class="col-md-9">
                                                <textarea
                                                    <textarea style="height: 300px" id="editor" name="policy1">${requestScope.category.policy1}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea
                                                    ...
                                                    name="policy2"
                                                    style="height: 300px"
                                                    >${requestScope.category.policy2}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea
                                                    ...
                                                    name="policy3"
                                                    style="height: 300px"
                                                    >${requestScope.category.policy3}</textarea>
                                            </div>
                                        </div>
