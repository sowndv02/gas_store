<%-- 
    Document   : login
    Created on : May 13, 2023, 10:25:29 PM
    Author     : ADMIN
--%>
            ...
            <div class="breadcrumb-area">
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/client/index">Home</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xs-12 col-lg-10 mb-30">
                            <!-- Login Form s-->
                            <form id="myForm" action="${pageContext.request.contextPath}/client/login" method="post">
                                <h3 class="alert-danger">${requestScope.error}</h3>
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12 mb-20">
                                            ...
                                            <input required class="mb-0" name="username" id="username" type="text" placeholder="UserName"  value="${cookie.user.value}">
                                        </div>
                                        <div class="col-12 mb-20">
                                            <label>Password</label>
                                            <input required name="password" class="mb-0" type="password" placeholder="Password" id="password" value="${cookie.pass.value}">
                                            <i style="margin-left: -30px; cursor: pointer;" id="togglePassword" class="bi bi-eye-slash"></i>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="check-box d-inline-block ml-0 ml-md-2 mt-10">
                                                <input name="remember" type="checkbox" id="remember" value="ON" ${(cookie.cr.value eq 'ON')?"checked":""}>
                                                <label for="remember">Remember me</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-10 mb-20 text-left text-md-right">
                                            <a href="${pageContext.request.contextPath}/client/forgotpassword"> Quên mật khẩu?</a>
                                        </div>
                                        <div class="col-md-12 row flex_grid">
                                            <button type="button" onclick="checkUsernameAndPassword()" class="register-button mt-10 col-md-3 col-12">Login</button>
                                            <div class="w-100 d-md-none"></div>
                                            <button  type="button" style="background-color: white; color: black; border: 1px solid black;" class="register-button mt-10 col-md-3 col-12"><i class="fa fa-google">&nbsp;&nbsp;</i>
                                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:3979/gasstore/client/loginwithgoogle&response_type=code
                                                   &client_id=20642774012-1b6tv6k5p1tgtu5cbe09g8i33rbrrkn7.apps.googleusercontent.com&approval_prompt=force">Login Google</a></button>
                                            <div class="w-100 d-md-none"></div>
                                            <button type="button" class="register-button mt-10 col-md-3 col-12"><i class="fa fa-user-plus">&nbsp;&nbsp;</i><a href="${pageContext.request.contextPath}/client/register">Đăng ký</a></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
