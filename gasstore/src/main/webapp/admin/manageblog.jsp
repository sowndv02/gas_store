                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.blogs}" var="blog">
                                                <tr>
                                                    <td scope="row">${blog.blogId}</td>
                                                    <td scope="row">${blog.title}</td>
                                                    <td scope="row">${blog.datePost}</td>
                                                    <td scope="row">${blog.lastChange}</td>
                                                    <td scope="row">
                                                        <form action="updateblog" class="mb-3">
                                                            <input type="hidden" name = "blogId" value = "${blog.blogId}">
                                                            <i class="fas fa-edit" onmouseover="this.style.color='red'" onmouseout="this.style.color='black'" onclick="this.form.submit()"></i>
                                                        </form>
                                                        <form action="manageblog" method="post">
                                                            <input type="hidden" name="blogId" value="${blog.blogId}">
                                                            <input type="hidden" name="action" value="delete">
                                                            <i class="fas fa-times-circle" onmouseover="this.style.color='red'" onmouseout="this.style.color='black'" onclick="this.form.submit()"></i>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </c:forEach>
...
<script>
    const deleteForm = document.querySelector('form[action="manageblog"]');
    const deleteIcon = document.querySelector('.fas.fa-times-circle');
    ...
    const updateForm = document.querySelector('form[action="updateblog"]');
    const updateIcon = document.querySelector('.fas.fa-edit');
...
<style>
    .fas.fa-times-circle:hover, .fas.fa-edit:hover {
        cursor: pointer;
    }
</style>
