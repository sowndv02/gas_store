<%-- 
    Document   : contact
    Created on : May 23, 2023, 2:22:12 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            <div class="contact-page-side-content">
                                ...
                                <p class="contact-page-message mb-25">Cho chúng tôi biết bạn gặp phải vấn đề gì</p>
                        ...
                        <div class="col-lg-6 col-md-12 order-2 order-lg-1">
                            <div class="contact-form-content pt-sm-55 pt-xs-55">
                                ...
                                <h4 class="alert-danger">${requestScope.msg}</h4>
                                <div class="contact-form">
                                    <form  action="${pageContext.request.contextPath}/client/contact" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>Subject</label>
                                            <input type="text" required name="contactSubject" id="contactSubject">
                                        </div>
                                        <div class="form-group mb-30">
                                            <label>Your Message</label>
                                            <textarea name="contactMessage" required id="contactMessage" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <button class="li-btn-3" >send</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
