<%-- 
    Document   : about-us
    Created on : May 28, 2023, 9:01:25 PM
    Author     : ADMIN
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-10">
                            <div class="about-image-wrap">
                                <img class="img-full" src="${aboutUs.img}" alt="About Us" />
                            </div>
                        </div>
                        <!-- About Image End -->
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <!-- Team member begins here -->

                            <div class="row">
                                <div class="special-product-active owl-carousel">
                                    <!-- single-teammember-wrap start -->
