 ...
 * @author ADMIN
 */
public class AuthenticationOTPClientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AuthenticationOTPClientServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AuthenticationOTPClientServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("headers", headers);
            ...
            if (AES.encrypt(otp).equals(otpSend)) {
                request.setAttribute("email", email);
            ...
            Logger.getLogger(AuthenticationOTPClientServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
