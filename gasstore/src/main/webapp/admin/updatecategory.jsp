<%-- 
    ...
    Created on : May 19, 2023, 1:23:24 AM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Cập nhật (${requestScope.category.name})</title>
        <!-- Favicon icon -->
        <link
            rel="icon"
            type="image/png"
                            ...
                            <form action="updatecategory" method="POST">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <p style="color: red;">Vui lòng không nhập tên và code đã có ở bảng trên!</p>
                                            <label
                                                for="code"
                                                class="col-md-3 ">Code</label>
                                            <div class="col-md-9">
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="code"
                                                    value="${requestScope.category.code}"
                                                    placeholder="Input"
                                                    name="code"
                                                    required
                                                    />
                                        ...
                                        <div class="form-group row">
                                            <label
                                                for="keyword"
                                                class="col-md-3 ">Keyword</label>
                                            <div class="col-md-9">
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="keyword"
                                                    value="${requestScope.category.keyword}"
                                                    placeholder="Input"
                                                    name="keyword"
                                                    />
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="editor" name="des" style="width:100%; height: 200px">
                                        ...
                                        <div class="form-group row">
                                            <label
                                                for="createdDate"
                                                class="col-md-3 ">Ngày tạo</label>
                                            <div class="col-md-9">
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="createdDate"
                                                    value="${requestScope.category.createdDate}"
                                                    placeholder="Input"
                                                    name="createdDate"
                                                    readonly
                                                    />
                                        ...
                                        <div class="form-group row">
                                            <label
                                                for="createdBy"
                                                class="col-md-3 ">Tác giả</label>
                                            <div class="col-md-9">
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="createdBy"
                                                    value="${requestScope.category.admin.userName}"
                                                    placeholder="Input"
                                                    name="createdBy"
                                                    readonly
                                                    />
