                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="li-product-price">Đơn vị giá</th>
                                            <th class="li-product-price">Giảm giá</th>
                                            <th class="li-product-quantity">Số lượng</th>
                                            <th class="li-product-subtotal">Tiền</th>
                                            <th class="li-product-remove">Xóa</th>
                                        </tr>
                                    </thead>
                                    <c:forEach items="${o.items}" var="i">
                                        <tbody class="del${i.product.productId}">
                                            <tr>
                                                <td class="li-product-thumbnail"><a href="${pageContext.request.contextPath}/client/products?id=${i.product.productId}" class="minicart-product-image"><img  src="${pageContext.request.contextPath}/${i.product.base64Image}" alt="Preview" style="width:110px"/></td>
                                                <td class="li-product-name">${i.product.name}</td>
                                                <td class="li-product-price"><span class="amount"><fmt:formatNumber value = "${Math.round((i.product.unitPrice)/1000)*1000}" type = "currency"/></span></td>
                                                <td class="li-product-price"><span class="amount"><fmt:formatNumber value = "${i.product.discount.discount}" type = "percent"/></span></td>
                                                <td class="quantity">
                                                    <div class="cart-cong-tru">
                                                        <input class="cart-plus-minus-box" id="num" value="${i.quantity}" type="text">
                                                        <div onclick="c(${i.product.productId})" class="dec qtybutton"><i class="fa fa-angle-down"></i></div>
                                                        <div onclick="b(${i.product.productId})" class="inc qtybutton"><i class="fa fa-angle-up"></i></div>
                                                    </div>
                                                </td>
                                                <td class="product-subtotal"><span class="amount ad${i.product.productId}"><fmt:formatNumber value = "${Math.round((i.product.unitPrice - i.product.unitPrice * i.product.discount.discount)/1000)*1000*i.quantity}" type = "currency"/></span></td>
                                                <td><button onclick="a(${i.product.productId})" class="close" title="Remove" style="float: none"><i class="fa fa-close"></i></button></td>
                                ...
                                <div class="col-12">
                                    <div class="coupon-all">
                                        <div class="coupon">
                                            ...
                                            <input class="button" name="apply_coupon" value="Dùng coupon">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row coup">
                                <div class="col-md-5 ml-auto">
                                    <div class="cart-page-total">
                                        <h2>Giỏ Hàng</h2>
                                        <ul>
                                            <li >Tổng phụ <span class="minicart-total"><fmt:formatNumber value="${Math.round((o.totalMoney)/1000)*1000}" type="currency"/></span></li>
                                            <li >Tổng <span class="minicart-total"><fmt:formatNumber value="${Math.round((o.totalMoney)/1000)*1000}" type="currency"/></span></li>

                                        </ul>
                                        <a href="${pageContext.request.contextPath}/client/checkout">Thanh Toán</a>
                                    </div>
                                </div>
                            </div>
                        </div>
