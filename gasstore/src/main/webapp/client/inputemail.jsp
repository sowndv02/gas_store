<%-- 
    Document   : inputemail
    Created on : May 15, 2023, 9:17:06 PM
    Author     : ADMIN
--%>
...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>Hỗ trợ mật khẩu- Email</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-10 col-xs-12">
                            ...
                            <form id="myForm" action="${pageContext.request.contextPath}/client/forgotpassword" method="POST">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input required class="mb-0" type="email" id="email" name="email" placeholder="Email Address">
                                        </div>

                                        <div class="col-12">
                                            <button type="button" onclick="validateForgotPasswordForm()" class="register-button mt-0">Tiếp tục</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
