<%-- 
    ...
    Created on : May 19, 2023, 11:40:51 AM
    Author     : ADMIN
--%>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.listAllFaq}" var="f">
                                                    <tr>
                                                        <th scope="row">${f.faqID}</th>
                                                        <td>${f.question}</td>
                                                        <td>${f.admin.userName}</td>
                                                        <td>${f.createdDate}</td>
                                                        <td><c:if test="${f.isActive}">Hoạt động</c:if><c:if test="${!f.isActive}">Ngừng hoạt động</c:if></td>
                                                        <td><a  class="fas fa-edit" href="${pageContext.request.contextPath}/admin/updatefaq?update=${f.faqID}" ></a></td>
                                                                <td><a class=" fas fa-window-close" onclick="cfDelete(${f.faqID})" style="cursor: pointer" ></a></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
...
<script>
    ...
    function cfDelete(id) {
        if (confirm("Are you sure you want delete this faq ?")) {
            window.location.href = "${pageContext.request.contextPath}/admin/updatefaq?delete=" + id;
        }
    }
